...
set(SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemble
...
set_source_files_properties(${SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemblePreproc)
set_source_files_properties(${SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemblePreproc} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_assemblePreproc})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_compile
...
set_source_files_properties(${SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(SCCP1_dsPIC33CK_default_default_XC_DSC_FILE_TYPE_compile_cpp
...
set(SCCP1_dsPIC33CK_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/SCCP1_dsPIC33CK")

# The full path to the final image.
set(SCCP1_dsPIC33CK_default_full_path_to_image ${SCCP1_dsPIC33CK_default_output_dir}/${SCCP1_dsPIC33CK_default_image_name})
