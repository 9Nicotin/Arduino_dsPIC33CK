/*
 * pins_arduino.h - Pin mapping for dsPIC33CK256MC002
 *
 * dsPIC33CK256MC002 is a 28-pin Motor Control device with:
 *   - PORTA: RA0-RA4 (all analog-capable)
 *   - PORTB: RB0-RB15 (RB0-RB4, RB7-RB9 analog-capable)
 *   - 256KB Flash, 16KB RAM
 *   - DFP: dsPIC33CK-MC_DFP
 *
 * Arduino Pin Mapping:
 *   D0-D4   = RA0-RA4 (PORTA, all have analog)
 *   D5-D20  = RB0-RB15 (PORTB)
 *   A0-A4   = AN0-AN4 (RB0-RB4)
 *   A5-A7   = AN8-AN10 (RB7-RB9)
 *   A8-A12  = ANA0-ANA4 (RA0-RA4)
 *
 * PWM Pins: D5(RB0), D6(RB1), D7(RB2), D8(RB3) via PWM Generator
...
/* Analog pin aliases (PORTB channels) */
#define A0  5   /* RB0 = AN0 */
#define A1  6   /* RB1 = AN1 */
#define A2  7   /* RB2 = AN2 */
#define A3  8   /* RB3 = AN3 */
#define A4  9   /* RB4 = AN4 */
#define A5  12  /* RB7 = AN8 */
#define A6  13  /* RB8 = AN9 */
#define A7  14  /* RB9 = AN10 */

/* Analog pin aliases (PORTA channels) */
#define A8  0   /* RA0 = ANA0 */
#define A9  1   /* RA1 = ANA1 */
#define A10 2   /* RA2 = ANA2 */
#define A11 3   /* RA3 = ANA3 */
#define A12 4   /* RA4 = ANA4 */
